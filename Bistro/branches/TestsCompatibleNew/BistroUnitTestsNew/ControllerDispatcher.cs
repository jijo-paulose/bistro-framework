...
//            public BindingTest[] BindingTree { get; set; }
        ...
        {
            return new TestTypeInfo.TestAttributeInfo(typeof(BindAttribute), new Bistro.Reflection.CLRTypeInfo.Parameter("Target", binding), new Bistro.Reflection.CLRTypeInfo.Parameter("ControllerBindType", BindType.Before),new Bistro.Reflection.CLRTypeInfo.Parameter("Priority",-1));
        }
