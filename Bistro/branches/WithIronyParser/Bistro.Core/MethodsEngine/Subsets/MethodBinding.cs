...
namespace Bistro.MethodsEngine.Subsets
{
    ...
    /// </summary>
    public class MethodBindingTuple
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="MethodBindingTuple"/> class.
        /// </summary>
        ...
        internal MethodBindingTuple(string _verbNormalizedUrl ,Engine _engine)
        {
        ...
        /// <returns>MethodBinding with the appropriate matchstatus.</returns>
        ...
        /// <summary>
        /// Gets or sets a value indicating whether this <see cref="MethodBindingTuple"/> is processed.
        /// </summary>
    ...
    public class MethodBinding
    {
        ...
        internal MethodBinding(string _verbNormalizedUrl, bool _matchStatus, Engine _engine)
        {
            engine = _engine;
		...
		/// <summary>
		/// Extracts the parameters from the MethodBinding. Request url must match this binding - there's no check for validation here.
		/// </summary>
        ...
        /// <summary>
        /// Compares this Methodbinding with another MethodBinding for intersection. Both must have match status set to true 
        /// for this part of algorithm to work properly
        /// </summary>
        /// <param name="matchBind">Another MethodBinding object.</param>
        ...
        /// <summary>
        /// Compares two MethodBindings with different match statuses for intersection
        /// </summary>
