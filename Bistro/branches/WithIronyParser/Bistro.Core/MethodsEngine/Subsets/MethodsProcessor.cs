...
namespace Bistro.MethodsEngine.Subsets
{
    ...
    public class MethodsProcessor
    {
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="MethodsProcessor"/> class.
        /// </summary>
        /// <param name="_engine">The engine.</param>
        internal MethodsProcessor(Engine _engine)
        {
            engine = _engine;
        ...
        /// </summary>
        internal List<GenBindingTuple> allBindings;

        /// <summary>
        /// List to store all the methods.
        /// </summary>
        internal List<BistroMethod> allMethods;


		internal Dictionary<string, BistroMethod> methodsDictionary;
