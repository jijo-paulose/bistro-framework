		...
		internal IList<TestDescriptor> TestSource()
		{
			...
			NewTestWithUrl("Big Test",
				Types(
                    ...
                    UrlTest("GET /Pageable?{PageNumber}&{PageSize}", "GET /Pageable?{PageNumber}&{PageSize}", CtrUnOrdGrp("Messenger", "Fake", "DefaultController", "Authenticator", "AntiForgeryRequestSetter", "AjaxDeterminer", CtrOrdGrp("QueryStringDeterminer", "Pageable"))),
                    UrlTest("GET /abcde/edcba/aaaa123/bbb124/Pageable?{PageNumber}&{PageSize}", "GET /abcde/edcba/aaaa123/bbb124/Pageable?{PageNumber}&{PageSize}", CtrUnOrdGrp("Messenger", "Fake", "DefaultController", "Authenticator", "AntiForgeryRequestSetter", "AjaxDeterminer", CtrOrdGrp("QueryStringDeterminer", "Pageable"))),
                    UrlTest("GET /bbb124/Pageable?{PageNumber}&{PageSize}", "GET /bbb124/Pageable?{PageNumber}&{PageSize}", CtrUnOrdGrp("Messenger", "Fake", "DefaultController", "Authenticator", "AntiForgeryRequestSetter", "AjaxDeterminer", CtrOrdGrp("QueryStringDeterminer", "Pageable"))),
                    UrlTest("GET /aaaa123/bbb124/Pageable?{PageNumber}&{PageSize}", "GET /aaaa123/bbb124/Pageable?{PageNumber}&{PageSize}", CtrUnOrdGrp("Messenger", "Fake", "DefaultController", "Authenticator", "AntiForgeryRequestSetter", "AjaxDeterminer", CtrOrdGrp("QueryStringDeterminer", "Pageable"))),
                    UrlTest("GET /Sortable?{OrderBy}&{Direction}", "GET /Sortable?{OrderBy}&{Direction}", CtrUnOrdGrp("Messenger", "Fake", "DefaultController", "Authenticator", "AntiForgeryRequestSetter", "AjaxDeterminer", CtrOrdGrp("QueryStringDeterminer", "Sortable"))),
                    UrlTest("GET /abcde/edcba/aaaa123/bbb124/Sortable?{OrderBy}&{Direction}", "GET /abcde/edcba/aaaa123/bbb124/Sortable?{OrderBy}&{Direction}", CtrUnOrdGrp("Messenger", "Fake", "DefaultController", "Authenticator", "AntiForgeryRequestSetter", "AjaxDeterminer", CtrOrdGrp("QueryStringDeterminer", "Sortable"))),
                    UrlTest("GET /bbb124/Sortable?{OrderBy}&{Direction}", "GET /bbb124/Sortable?{OrderBy}&{Direction}", CtrUnOrdGrp("Messenger", "Fake", "DefaultController", "Authenticator", "AntiForgeryRequestSetter", "AjaxDeterminer", CtrOrdGrp("QueryStringDeterminer", "Sortable"))),
                    UrlTest("GET /aaaa123/bbb124/Sortable?{OrderBy}&{Direction}", "GET /aaaa123/bbb124/Sortable?{OrderBy}&{Direction}", CtrUnOrdGrp("Messenger", "Fake", "DefaultController", "Authenticator", "AntiForgeryRequestSetter", "AjaxDeterminer", CtrOrdGrp("QueryStringDeterminer", "Sortable"))),
                    UrlTest("GET /abcde/edcba/aaaa123/bbb124", "GET /abcde/edcba/aaaa123/bbb124", CtrUnOrdGrp("Messenger", "QueryStringDeterminer", "DefaultController", "Fake", "Authenticator", "AjaxDeterminer", "AntiForgeryRequestSetter")),
                    UrlTest("GET /bbb124", "GET /bbb124", CtrUnOrdGrp("Messenger", "QueryStringDeterminer", "DefaultController", "Fake", "Authenticator", "AjaxDeterminer", "AntiForgeryRequestSetter")),
                    UrlTest("GET /aaaa123/bbb124", "GET /aaaa123/bbb124", CtrUnOrdGrp("Messenger", "QueryStringDeterminer", "DefaultController", "Fake", "Authenticator", "AjaxDeterminer", "AntiForgeryRequestSetter")),
                    UrlTest("POST /abcde/edcba/aaaa123/bbb124", "POST /abcde/edcba/aaaa123/bbb124", CtrUnOrdGrp("Messenger", "QueryStringDeterminer", "DefaultController", "Fake", "Authenticator", "AjaxDeterminer", "AntiForgeryRequestHandler")),
                    UrlTest("POST /bbb124", "POST /bbb124", CtrUnOrdGrp("Messenger", "QueryStringDeterminer", "DefaultController", "Fake", "Authenticator", "AjaxDeterminer", "AntiForgeryRequestHandler")),
                    UrlTest("POST /aaaa123/bbb124", "POST /aaaa123/bbb124", CtrUnOrdGrp("Messenger", "QueryStringDeterminer", "DefaultController", "Fake", "Authenticator", "AjaxDeterminer", "AntiForgeryRequestHandler")),
                    UrlTest("PUT /abcde/edcba/aaaa123/bbb124", "PUT /abcde/edcba/aaaa123/bbb124", CtrUnOrdGrp("Messenger", "QueryStringDeterminer", "DefaultController", "Authenticator", "AjaxDeterminer", "Fake")),
                    UrlTest("PUT /bbb124", "PUT /bbb124", CtrUnOrdGrp("Messenger", "QueryStringDeterminer", "DefaultController", "Authenticator", "AjaxDeterminer", "Fake")),
                    UrlTest("PUT /aaaa123/bbb124", "PUT /aaaa123/bbb124", CtrUnOrdGrp("Messenger",  "QueryStringDeterminer", "DefaultController", "Authenticator", "AjaxDeterminer", "Fake")),
                    UrlTest("DELETE /abcde/edcba/aaaa123/bbb124", "DELETE /abcde/edcba/aaaa123/bbb124", CtrUnOrdGrp("Messenger", "QueryStringDeterminer", "DefaultController", "Authenticator", "AjaxDeterminer", "Fake")),
                    UrlTest("DELETE /bbb124", "DELETE /bbb124", CtrUnOrdGrp("Messenger", "QueryStringDeterminer", "DefaultController", "Authenticator", "AjaxDeterminer", "Fake")),
                    UrlTest("DELETE /aaaa123/bbb124", "DELETE /aaaa123/bbb124", CtrUnOrdGrp("Messenger", "QueryStringDeterminer", "DefaultController", "Authenticator", "AjaxDeterminer", "Fake")),
                    UrlTest("GET /Bar/", "GET /Bar/", CtrUnOrdGrp("Messenger", CtrOrdGrp(CtrUnOrdGrp("QueryStringDeterminer", "DefaultController"), "Bar"), "Fake", "Authenticator", "AjaxDeterminer", "AntiForgeryRequestSetter")),
                    UrlTest("GET /Bar/variablevalue1", "GET /Bar/variablevalue1", CtrUnOrdGrp("Messenger", CtrOrdGrp(CtrUnOrdGrp("QueryStringDeterminer", "DefaultController"), "Bar"), "Fake", "Authenticator", "AjaxDeterminer", "AntiForgeryRequestSetter")),
                    UrlTest("GET /Bar/123412423", "GET /Bar/123412423", CtrUnOrdGrp("Messenger", CtrOrdGrp(CtrUnOrdGrp("QueryStringDeterminer", "DefaultController"), "Bar"), "Fake", "Authenticator", "AjaxDeterminer", "AntiForgeryRequestSetter")),
                    UrlTest("GET /Bar/testvalue", "GET /Bar/testvalue", CtrUnOrdGrp("Messenger", CtrOrdGrp(CtrUnOrdGrp("QueryStringDeterminer", "DefaultController"), "Bar"), "Fake", "Authenticator", "AjaxDeterminer", "AntiForgeryRequestSetter")),
                    UrlTest("DELETE /Bar/", "DELETE /Bar/", CtrUnOrdGrp("Messenger", CtrOrdGrp(CtrUnOrdGrp("QueryStringDeterminer", "DefaultController"), "BarDelete"), "Authenticator", "AjaxDeterminer", "Fake")),
                    UrlTest("DELETE /Bar/variablevalue1", "DELETE /Bar/variablevalue1", CtrUnOrdGrp("Messenger", CtrOrdGrp(CtrUnOrdGrp("QueryStringDeterminer", "DefaultController"), "BarDelete"), "Authenticator", "AjaxDeterminer", "Fake")),
                    UrlTest("DELETE /Bar/123412423", "DELETE /Bar/123412423", CtrUnOrdGrp("Messenger", CtrOrdGrp(CtrUnOrdGrp("QueryStringDeterminer", "DefaultController"), "BarDelete"), "Authenticator", "AjaxDeterminer", "Fake")),
                    UrlTest("DELETE /Bar/testvalue", "DELETE /Bar/testvalue", CtrUnOrdGrp("Messenger", CtrOrdGrp(CtrUnOrdGrp("QueryStringDeterminer", "DefaultController"), "BarDelete"), "Authenticator", "AjaxDeterminer", "Fake")),
                    UrlTest("GET /Bars", "GET /Bars", CtrUnOrdGrp("Messenger", CtrOrdGrp(CtrUnOrdGrp("QueryStringDeterminer", "DefaultController"), "Bars"), "AjaxDeterminer", "Authenticator", "Fake", "AntiForgeryRequestSetter")),
                    UrlTest("GET /Clinical/GetNextStep?{TransactionId}&{Data17isId}", "GET /Clinical/GetNextStep?{TransactionId}&{Data17isId}", CtrUnOrdGrp("Messenger", "QueryStringDeterminer", "DefaultController", "Fake", "Authenticator", "AjaxDeterminer", "AntiForgeryRequestSetter", "GetNextStep")),
                    UrlTest("GET /Clinical/Initialize", "GET /Clinical/Initialize", CtrUnOrdGrp("Messenger", "QueryStringDeterminer", "DefaultController", "Fake", "Authenticator", "AjaxDeterminer", "AntiForgeryRequestSetter", "InitializeClinical")),
                    UrlTest("GET /Comments", "GET /Comments", CtrUnOrdGrp("Messenger", CtrOrdGrp(CtrUnOrdGrp("QueryStringDeterminer", "DefaultController"), "Comments"), "AjaxDeterminer", "Authenticator", "Fake", "AntiForgeryRequestSetter")),
                    UrlTest("GET /Comments/Get", "GET /Comments/Get", CtrUnOrdGrp("Messenger", CtrOrdGrp(CtrUnOrdGrp("QueryStringDeterminer", "DefaultController"), CtrUnOrdGrp("CommentsSend", "Comments")), "AjaxDeterminer", "Authenticator", "Fake", "AntiForgeryRequestSetter")),
                    UrlTest("GET /DrugCategories", "GET /DrugCategories", CtrUnOrdGrp("Messenger", CtrOrdGrp("QueryStringDeterminer", "DrugCategories"), "DefaultController", "AjaxDeterminer", "Authenticator", "Fake", "AntiForgeryRequestSetter")),
                    UrlTest("GET /Drugs", "GET /Drugs", CtrUnOrdGrp("Messenger", CtrOrdGrp("QueryStringDeterminer", "Drugs"), "DefaultController", "AjaxDeterminer", "Authenticator", "Fake", "AntiForgeryRequestSetter")),
                    UrlTest("GET /Enrollments", "GET /Enrollments", CtrUnOrdGrp("Messenger", CtrOrdGrp(CtrUnOrdGrp("QueryStringDeterminer", "DefaultController"), "Enrollments"), "AjaxDeterminer", "Authenticator", "Fake", "AntiForgeryRequestSetter")),
                    UrlTest("GET /default", "GET /default", CtrUnOrdGrp("QueryStringDeterminer", "Messenger", "AjaxDeterminer", CtrOrdGrp(CtrUnOrdGrp("Authenticator", "DefaultController"), "HomeController"), "Fake", "AntiForgeryRequestSetter")),
                    UrlTest("GET /EligibilityRouter", "GET /EligibilityRouter", CtrUnOrdGrp(CtrOrdGrp(CtrUnOrdGrp("QueryStringDeterminer", "DefaultController"), "EligibilityRouter"), "Foo", "Messenger", "AjaxDeterminer", "Authenticator", "Fake", "AntiForgeryRequestSetter")),
                    UrlTest("GET /Foos", "GET /Foos", CtrUnOrdGrp("Messenger", "AjaxDeterminer", CtrOrdGrp(CtrUnOrdGrp("QueryStringDeterminer", "DefaultController", "Authenticator"), "Foos"), "Fake", "AntiForgeryRequestSetter")),
                    UrlTest("GET /OrderManager/OrderInquiry", "GET /OrderManager/OrderInquiry", CtrUnOrdGrp("Messenger", "QueryStringDeterminer", CtrOrdGrp(CtrUnOrdGrp("Authenticator", "DefaultController"), "OrderInquiry"), "Fake", "AjaxDeterminer", "AntiForgeryRequestSetter")),
                    UrlTest("GET /OrderManager/OrderInquiry/OrderListBySite", "GET /OrderManager/OrderInquiry/OrderListBySite", CtrUnOrdGrp("Messenger", CtrOrdGrp(CtrUnOrdGrp("QueryStringDeterminer", "DefaultController", "Fake", "Authenticator"), CtrUnOrdGrp("OrderInquiry", "OrderInquiryListBySite")), "AjaxDeterminer", "AntiForgeryRequestSetter")),
                    UrlTest("GET /OrderManager/OrderRequest/DeleteBar", "GET /OrderManager/OrderRequest/DeleteBar", CtrUnOrdGrp("Messenger", CtrOrdGrp(CtrUnOrdGrp("QueryStringDeterminer", "DefaultController", "Authenticator"), CtrUnOrdGrp("OrderRequest", "DeleteBar")), "Fake", "AjaxDeterminer", "AntiForgeryRequestSetter", "StepWizard")),
                    UrlTest("GET /OrderManager/OrderRequest/ProcessBarDeletion", "GET /OrderManager/OrderRequest/ProcessBarDeletion", CtrUnOrdGrp("Messenger", CtrOrdGrp(CtrUnOrdGrp("QueryStringDeterminer", "DefaultController", "Authenticator"), CtrUnOrdGrp("OrderRequest", "ProcessBarDeletion")), "Fake", "AjaxDeterminer", "AntiForgeryRequestSetter", "StepWizard")),
                    UrlTest("GET /DrugSelector?{CategoryId}&{DrugId}", "GET /DrugSelector?{CategoryId}&{DrugId}", CtrUnOrdGrp("Messenger", CtrOrdGrp(CtrUnOrdGrp("QueryStringDeterminer", "DefaultController", "Authenticator"), "DrugSelector"), "AjaxDeterminer", "Fake", "AntiForgeryRequestSetter")),
                    UrlTest("GET /EligibilityRouter", "GET /EligibilityRouter", CtrUnOrdGrp(CtrOrdGrp(CtrUnOrdGrp("QueryStringDeterminer", "DefaultController"), CtrUnOrdGrp("EligibilityRouter", "Foo")), "Messenger", "AjaxDeterminer", "Authenticator", "Fake", "AntiForgeryRequestSetter")),
                    UrlTest("GET /OrderManager/OrderRequest/FooHistoryList", "GET /OrderManager/OrderRequest/FooHistoryList", CtrUnOrdGrp("Messenger", CtrOrdGrp(CtrUnOrdGrp("QueryStringDeterminer", "DefaultController", "Authenticator"), CtrUnOrdGrp("OrderRequest", "FooHistoryList")), "Fake", "AjaxDeterminer", "AntiForgeryRequestSetter", "StepWizard")),
                    UrlTest("GET /OrderManager/OrderRequest/FooInformation", "GET /OrderManager/OrderRequest/FooInformation", CtrUnOrdGrp("Messenger", "QueryStringDeterminer", CtrOrdGrp(CtrUnOrdGrp("DefaultController", "Authenticator"), "OrderRequest"), "Fake", "AjaxDeterminer", "AntiForgeryRequestSetter", "FooInformation", "StepWizard")),
                    UrlTest("GET /OrderManager/OrderRequest", "GET /OrderManager/OrderRequest", CtrUnOrdGrp("Messenger", "QueryStringDeterminer", CtrOrdGrp(CtrUnOrdGrp("DefaultController", "Authenticator"), "OrderRequest"), "Fake", "AjaxDeterminer", "AntiForgeryRequestSetter", "StepWizard")),
                    UrlTest("GET /OrderRequestQueue", "GET /OrderRequestQueue", CtrUnOrdGrp("QueryStringDeterminer", "Messenger", "DefaultController", "AjaxDeterminer", CtrOrdGrp("Authenticator", "OrderRequestQueue"), "Fake", "AntiForgeryRequestSetter")),
                    UrlTest("GET /OrderManager/OrderRequest/PhysicianSelector?{PhysicianId}", "GET /OrderManager/OrderRequest/PhysicianSelector?{PhysicianId}", CtrUnOrdGrp("Messenger", "QueryStringDeterminer", "DefaultController", "Fake", "Authenticator", "AjaxDeterminer", "AntiForgeryRequestSetter", "OrderRequest", "PhysicianSelector", "StepWizard")),
                    UrlTest("GET /OrderManager/OrderRequest", "GET /OrderManager/OrderRequest", CtrUnOrdGrp("Messenger", "QueryStringDeterminer", "Fake", CtrOrdGrp(CtrUnOrdGrp("DefaultController", "Authenticator"), "OrderRequest"), "AjaxDeterminer", "AntiForgeryRequestSetter", "StepWizard")),
                    UrlTest("GET /Physicians", "GET /Physicians", CtrUnOrdGrp("Messenger", CtrOrdGrp(CtrUnOrdGrp("QueryStringDeterminer", "DefaultController", "Authenticator"), "Physicians"), "AjaxDeterminer", "Fake", "AntiForgeryRequestSetter")),
                    UrlTest("GET /Data14s", "GET /Data14s", CtrUnOrdGrp("Messenger", CtrOrdGrp(CtrUnOrdGrp("QueryStringDeterminer", "DefaultController", "Authenticator"), "Foos"), "AjaxDeterminer", "Fake", "AntiForgeryRequestSetter")),
                    UrlTest("GET /QUnit", "GET /QUnit", CtrUnOrdGrp("QueryStringDeterminer", "Messenger", "QUnit", "DefaultController", "AjaxDeterminer", "Authenticator", "Fake", "AntiForgeryRequestSetter")),
                    UrlTest("GET /RequestItems", "GET /RequestItems", CtrUnOrdGrp("Messenger", CtrOrdGrp(CtrUnOrdGrp("DefaultController", "QueryStringDeterminer"), "RequestItems"), "AjaxDeterminer", "Authenticator", "Fake", "AntiForgeryRequestSetter")),
                    UrlTest("GET /abcde/edcba/aaaa123/bbb124", "GET /abcde/edcba/aaaa123/bbb124", CtrUnOrdGrp("Messenger", "QueryStringDeterminer", "DefaultController", "Fake", "Authenticator", "AjaxDeterminer", "AntiForgeryRequestSetter")),
                    UrlTest("GET /bbb124", "GET /bbb124", CtrUnOrdGrp("Messenger", "QueryStringDeterminer", "DefaultController", "Fake", "Authenticator", "AjaxDeterminer", "AntiForgeryRequestSetter")),
                    UrlTest("GET /aaaa123/bbb124", "GET /aaaa123/bbb124", CtrUnOrdGrp("Messenger", "QueryStringDeterminer", "DefaultController", "Fake", "Authenticator", "AjaxDeterminer", "AntiForgeryRequestSetter")),
                    UrlTest("POST /abcde/edcba/aaaa123/bbb124", "POST /abcde/edcba/aaaa123/bbb124", CtrUnOrdGrp("Messenger", "QueryStringDeterminer", "DefaultController", "Fake", "Authenticator", "AjaxDeterminer", "AntiForgeryRequestHandler")),
                    ...
                    UrlTest("DELETE /bbb124", "DELETE /bbb124", CtrUnOrdGrp("Messenger", "QueryStringDeterminer", "DefaultController", "Authenticator", "AjaxDeterminer", "Fake")),
                    UrlTest("DELETE /aaaa123/bbb124", "DELETE /aaaa123/bbb124", CtrUnOrdGrp("Messenger", "QueryStringDeterminer", "DefaultController", "Authenticator", "AjaxDeterminer", "Fake")),
                    UrlTest("GET /", "GET /", CtrUnOrdGrp("QueryStringDeterminer", "Messenger", "RootRedirect", "DefaultController", "AjaxDeterminer", "Authenticator", "Fake", "AntiForgeryRequestSetter")),
                    UrlTest("POST /", "POST /", CtrUnOrdGrp("QueryStringDeterminer", "Messenger", "RootRedirect", "DefaultController", "AjaxDeterminer", "Authenticator", "Fake", "AntiForgeryRequestHandler")),
                    UrlTest("PUT /", "PUT /", CtrUnOrdGrp("QueryStringDeterminer", "DefaultController", "RootRedirect", "Messenger", "Authenticator", "AjaxDeterminer", "Fake")),
                    UrlTest("DELETE /", "DELETE /", CtrUnOrdGrp("QueryStringDeterminer", "DefaultController", "RootRedirect", "Messenger", "Authenticator", "AjaxDeterminer", "Fake")),
                    UrlTest("GET /abcde/edcba/aaaa123/bbb124", "GET /abcde/edcba/aaaa123/bbb124", CtrUnOrdGrp("Messenger", "QueryStringDeterminer", "DefaultController", "Fake", "Authenticator", "AjaxDeterminer", "AntiForgeryRequestSetter")),
                    UrlTest("GET /bbb124", "GET /bbb124", CtrUnOrdGrp("Messenger", "QueryStringDeterminer", "DefaultController", "Fake", "Authenticator", "AjaxDeterminer", "AntiForgeryRequestSetter")),
                    UrlTest("GET /aaaa123/bbb124", "GET /aaaa123/bbb124", CtrUnOrdGrp("Messenger", "QueryStringDeterminer", "DefaultController", "Fake", "Authenticator", "AjaxDeterminer", "AntiForgeryRequestSetter")),
                    UrlTest("POST /abcde/edcba/aaaa123/bbb124", "POST /abcde/edcba/aaaa123/bbb124", CtrUnOrdGrp("Messenger", "QueryStringDeterminer", "DefaultController", "Fake", "Authenticator", "AjaxDeterminer", "AntiForgeryRequestHandler")),
