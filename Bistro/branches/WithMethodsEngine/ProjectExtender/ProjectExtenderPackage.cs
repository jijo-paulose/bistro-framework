...
namespace FSharp.ProjectExtender
{
    ...
    public sealed class ProjectExtenderPackage : Package
    {
        ...
        private void ProjectExtender(object sender, EventArgs e)
        {
            ...
            {
                projectTypeGuids = buildFile.CreateElement("ProjectTypeGuids",buildFile.DocumentElement.NamespaceURI);
            ...
            projReader.Close();
            var projWriter = new XmlTextWriter(new StreamWriter(projFile));
            buildFile.WriteContentTo(projWriter);
            projWriter.Close();
