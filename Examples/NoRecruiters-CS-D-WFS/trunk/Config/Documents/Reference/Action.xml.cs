...
//			Config\Documents\Reference\Action.xml
...
namespace NoRecruiters3 {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="Action", IsReference=true)]
    [DocumentVersion("b8833eb31aa5bc24e5cf26e2e7962a60e1c753b")]
    public partial class Action : WorkflowServer.Foundation.Documents.Document {
...
<xs:schema xmlns:wdf=""http://schemas.hill30.com/workflow/documents"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  <xs:element wdf:read=""s_action"" name=""document"">
    <xs:complexType>
      <xs:attribute wdf:param-name=""ActionId"" name=""docID"" type=""xs:ID"" />
      <xs:attribute name=""Description"" type=""xs:string"" />
        ...
        public Action(WorkflowServer.Foundation.Documents.DocumentFactory factory) : 
                base(factory) {
            return;
        }
        
        public Action(WorkflowServer.Foundation.Documents.DocumentFactory factory, System.Xml.XmlReader content) : 
        ...
        public static WorkflowServer.Foundation.Documents.Factories.StoredProcedure.Factory<Action> DefaultFactory {
            get {
                return ((WorkflowServer.Foundation.Documents.Factories.StoredProcedure.Factory<Action>)(WorkflowServer.Foundation.Documents.DocumentFactory.GetFactoryByName("Action")));
            }
        }
    }
}
