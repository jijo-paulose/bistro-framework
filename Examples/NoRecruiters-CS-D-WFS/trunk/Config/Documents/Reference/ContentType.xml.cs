...
//			Config\Documents\Reference\ContentType.xml
...
namespace NoRecruiters3 {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="ContentType", IsReference=true)]
    [DocumentVersion("4e2eef1b5ded36252f3997166cdbc219a1a0af")]
    public partial class ContentType : WorkflowServer.Foundation.Documents.Document {
...
<xs:schema xmlns:wdf=""http://schemas.hill30.com/workflow/documents"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  <xs:element wdf:read=""s_content_type"" name=""document"">
    <xs:complexType>
      <xs:attribute wdf:param-name=""ContentTypeId"" name=""docID"" type=""xs:ID"" />
      <xs:attribute name=""Description"" type=""xs:string"" />
        ...
        public ContentType(WorkflowServer.Foundation.Documents.DocumentFactory factory, System.Xml.XmlReader content) : 
        ...
        public static WorkflowServer.Foundation.Documents.Factories.StoredProcedure.Factory<ContentType> DefaultFactory {
            get {
                return ((WorkflowServer.Foundation.Documents.Factories.StoredProcedure.Factory<ContentType>)(WorkflowServer.Foundation.Documents.DocumentFactory.GetFactoryByName("ContentType")));
            }
        }
    }
}
