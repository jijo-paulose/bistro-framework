...
//			Config\Documents\Searches\Postings.xml
...
namespace NoRecruiters3 {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="Postings", IsReference=true)]
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(data_NodeCollection))]
    [DocumentVersion("1e3e4a9f2b4c0e88d79fb88cc79f9d2a3439ee")]
    public partial class Postings : WorkflowServer.Foundation.Documents.Document {
...
<xs:schema xmlns:wdf=""http://schemas.hill30.com/workflow/documents"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  <xs:element wdf:transient=""true"" wdf:skip-extra=""true"" name=""document"">
    <xs:complexType>
      <xs:sequence>
        <xs:element wdf:read=""s_postings(content_type)"" maxOccurs=""unbounded"" name=""data"">
          <xs:complexType>
      ...
      <xs:attribute wdf:transient=""true"" name=""docID"" type=""xs:ID"" />
        ...
        private NoRecruiters3.Postings.data_NodeCollection v1;
        ...
        [WorkflowServer.Foundation.Documents.DocumentFieldAttribute(FieldType=typeof(NoRecruiters3.Postings.data_Node), ValueFieldName="v1")]
        public virtual NoRecruiters3.Postings.data_NodeCollection data {
            get {
                return v1;
            }
        }
        
        public static WorkflowServer.Foundation.Documents.Factories.StoredProcedure.Factory<Postings> DefaultFactory {
            get {
                return ((WorkflowServer.Foundation.Documents.Factories.StoredProcedure.Factory<Postings>)(WorkflowServer.Foundation.Documents.DocumentFactory.GetFactoryByName("Postings")));
            }
        }
        
        [System.SerializableAttribute()]
        [System.Runtime.Serialization.DataContractAttribute(Name="data_NodeCollection", IsReference=true)]
        [System.Runtime.Serialization.KnownTypeAttribute(typeof(NoRecruiters3.Postings.data_Node))]
        public partial class data_NodeCollection : WorkflowServer.Foundation.Documents.DocumentNodeCollection {
            ...
            public virtual NoRecruiters3.Postings.data_Node AppendNode() {
                return ((NoRecruiters3.Postings.data_Node)(base.AppendNode()));
            }
            
            public virtual NoRecruiters3.Postings.data_Node InsertNodeBefore(NoRecruiters3.Postings.data_Node sibling) {
                return ((NoRecruiters3.Postings.data_Node)(base.InsertNodeBefore(sibling)));
            }
        }
