...
//			Config\Documents\Searches\UserPostings.xml
...
namespace NoRecruiters3 {
    ...
    [System.Runtime.Serialization.DataContractAttribute(Name="UserPostings", IsReference=true)]
    [System.Runtime.Serialization.KnownTypeAttribute(typeof(data_NodeCollection))]
    [DocumentVersion("806faa13fe51212d95904393482e63dd1419c5ee")]
    public partial class UserPostings : WorkflowServer.Foundation.Documents.Document {
...
<xs:schema xmlns:wdf=""http://schemas.hill30.com/workflow/documents"" xmlns:xs=""http://www.w3.org/2001/XMLSchema"">
  <xs:element wdf:transient=""true"" wdf:skip-extra=""true"" name=""document"">
    <xs:complexType>
      <xs:sequence>
        <xs:element wdf:read=""s_user_postings(user_id, [opt]published)"" maxOccurs=""unbounded"" name=""data"">
          <xs:complexType>
            ...
            <xs:attribute name=""ApplicantCount"" type=""xs:int"" />
          </xs:complexType>
        </xs:element>
      </xs:sequence>
      <xs:attribute wdf:transient=""true"" name=""docID"" type=""xs:ID"" />
        ...
        private NoRecruiters3.UserPostings.data_NodeCollection v1;
        
        public UserPostings(WorkflowServer.Foundation.Documents.DocumentFactory factory) : 
                base(factory) {
            return;
        }
        
        public UserPostings(WorkflowServer.Foundation.Documents.DocumentFactory factory, System.Xml.XmlReader content) : 
                base(factory, content) {
            return;
        }
        
        [WorkflowServer.Foundation.Documents.DocumentFieldAttribute(FieldType=typeof(NoRecruiters3.UserPostings.data_Node), ValueFieldName="v1")]
        public virtual NoRecruiters3.UserPostings.data_NodeCollection data {
            get {
                return v1;
            }
        }
        
        public static WorkflowServer.Foundation.Documents.Factories.StoredProcedure.Factory<UserPostings> DefaultFactory {
            get {
                return ((WorkflowServer.Foundation.Documents.Factories.StoredProcedure.Factory<UserPostings>)(WorkflowServer.Foundation.Documents.DocumentFactory.GetFactoryByName("UserPostings")));
            }
        }
        
        [System.SerializableAttribute()]
        [System.Runtime.Serialization.DataContractAttribute(Name="data_NodeCollection", IsReference=true)]
        [System.Runtime.Serialization.KnownTypeAttribute(typeof(NoRecruiters3.UserPostings.data_Node))]
        public partial class data_NodeCollection : WorkflowServer.Foundation.Documents.DocumentNodeCollection {
            ...
            public virtual NoRecruiters3.UserPostings.data_Node AppendNode() {
                return ((NoRecruiters3.UserPostings.data_Node)(base.AppendNode()));
            }
            
            public virtual NoRecruiters3.UserPostings.data_Node InsertNodeBefore(NoRecruiters3.UserPostings.data_Node sibling) {
                return ((NoRecruiters3.UserPostings.data_Node)(base.InsertNodeBefore(sibling)));
            }
        }
        ...
        public partial class data_Node : WorkflowServer.Foundation.Documents.DocumentNode {
            ...
            private System.Nullable<int> v6;
            ...
            private System.Nullable<int> o6;
            ...
            // Private field for the Value value of the the ApplicantCount document field
            [System.Runtime.Serialization.DataMemberAttribute(Name="v11", Order=2011, IsRequired=false)]
            private System.Nullable<int> v11;
            
            // Private field for the Original value of the the ApplicantCount document field
            [System.Runtime.Serialization.DataMemberAttribute(Name="o11", Order=3011, IsRequired=false)]
            private System.Nullable<int> o11;
            ...
            [WorkflowServer.Foundation.Documents.DocumentFieldAttribute(ValueFieldName="v6", OriginalFieldName="o6", Name="Views")]
            ...
            [WorkflowServer.Foundation.Documents.DocumentFieldAttribute(ValueFieldName="v7", OriginalFieldName="o7", Name="Deleted")]
            ...
            [WorkflowServer.Foundation.Documents.DocumentFieldAttribute(ValueFieldName="v8", OriginalFieldName="o8", Name="Flagged")]
            ...
            [WorkflowServer.Foundation.Documents.DocumentFieldAttribute(ValueFieldName="v9", OriginalFieldName="o9", Name="Published")]
            ...
            [WorkflowServer.Foundation.Documents.DocumentFieldAttribute(ValueFieldName="v10", OriginalFieldName="o10", Name="Active")]
            ...
            [WorkflowServer.Foundation.Documents.DocumentFieldAttribute(ValueFieldName="v11", OriginalFieldName="o11", Name="ApplicantCount")]
            private System.Nullable<int> @__ApplicantCount {
                get {
                    return v11;
                }
                set {
            ...
            public virtual System.Nullable<int> ApplicantCount {
                get {
                    return @__ApplicantCount;
                }
                set {
                    @__ApplicantCount = value;
                }
            }
        }
    }
